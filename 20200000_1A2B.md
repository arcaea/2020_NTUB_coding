...
public class Main {
	...
	// write your code here
        ...
        }while((pwd/1000)==0||b);//當pwd<1000且所有位數數字皆不同，重新產生一亂數
        ...
        do{
            ...
            System.out.println(CheckA(pwdAr,iAr)+"A"+CheckB(pwdAr,iAr)+"B");//印出幾A幾B
    ...
    static int CheckA(int[] pwd,int[] i){//取得傳遞值
        int cntA=0;//宣告變數
        for(int c=0;c<4;c++){//數字正確 位置正確
          if(pwd[c]==i[c]){
            cntA++;
          }
        }
    ...
    static int CheckB(int[] pwd,int[] i){//取得傳遞值
        int cntB=0;//宣告變數
